                ...
                if (URL_REGEX.test(part)) {
                    ...
                    return (
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 text-primary font-medium text-sm rounded-xl transition-colors"
                        >
