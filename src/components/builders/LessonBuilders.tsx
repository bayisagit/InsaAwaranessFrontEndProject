...
export function VideoBuilder({ form, setForm, onSave, onCancel, isSaving, moduleName }: BuilderProps) {
 ...
 <button className="flex-1 py-4 text-sm font-bold text-muted-foreground hover:text-foreground border-b-2 border-transparent hover:bg-muted transition-colors cursor-pointer">Upload Video</button>
 <button className="flex-1 py-4 text-sm font-bold text-primary border-b-2 border-primary bg-orange-50/30 cursor-pointer">External URL</button>
 </div>
 <div className="p-6">
...
export function ArticleBuilder({ form, setForm, onSave, onCancel, isSaving }: BuilderProps) {
 ...
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm font-bold text-foreground cursor-pointer">H1</button>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm font-bold text-foreground cursor-pointer">H2</button>
 <div className="w-px h-6 bg-gray-300 my-auto mx-1"></div>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm font-bold text-foreground cursor-pointer">B</button>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm italic text-foreground cursor-pointer">I</button>
 <div className="w-px h-6 bg-gray-300 my-auto mx-1"></div>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm text-foreground cursor-pointer">≡</button>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm text-foreground cursor-pointer">”</button>
 <button className="px-3 py-1.5 rounded hover:bg-gray-200 text-sm text-foreground cursor-pointer">🔗</button>
 </div>
 <textarea
...
export function ExternalToolBuilder({ form, setForm, onSave, onCancel, isSaving }: BuilderProps) {
 ...
 <button className="flex items-center justify-center gap-2 w-full py-4 text-sm font-bold text-red-500 hover:bg-primary/10 rounded-xl transition-colors cursor-pointer">
