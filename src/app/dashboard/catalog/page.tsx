...
export default function DashboardCatalogPage() {
    ...
    return (
        <div className="pb-20">
            <section className="relative overflow-hidden bg-white px-4 sm:px-6 lg:px-12 py-16 text-center flex flex-col items-center border-b border-gray-100 rounded-2xl mb-8">
