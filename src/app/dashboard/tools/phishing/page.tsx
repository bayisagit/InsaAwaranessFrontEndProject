...
export default function DashboardPhishingSimulationPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-foreground">Phishing Simulation</h1>
 <p className="text-sm text-muted-foreground">Test your ability to spot malicious emails.</p>
 </div>
 <div className="flex items-center gap-4">
 <div className="text-right">
 <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest block">Progress</span>
