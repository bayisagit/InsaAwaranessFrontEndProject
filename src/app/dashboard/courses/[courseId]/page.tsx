        ...
        return (
            <div className="min-h-screen bg-muted flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link href="/dashboard/courses" className="mt-4 text-primary hover:underline block">← Back to My Courses</Link>
                </div>
            </div>
        );
    }
        ...
        <SidebarProvider>
            ...
            <Sidebar className="border-r border-border bg-card">
                <SidebarHeader className="p-5 border-b border-border bg-muted/30">
                    <Link href="/dashboard/courses" className="inline-flex items-center gap-2 text-xs font-bold text-muted-foreground hover:text-primary transition-colors duration-200 uppercase tracking-widest">
                ...
                <SidebarContent className="p-3">
                    ...
                    <div className="mt-2 mb-2">
                        <Link href="/dashboard/certificates" className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-green-600 hover:bg-green-50 dark:hover:bg-green-500/10 transition-all duration-200">
                            <Award className="w-4 h-4" />
                            My Certificates
                        </Link>
                    </div>
                        ...
                        <div className="max-w-6xl mx-auto px-6 lg:px-12 pt-10 flex flex-col gap-12 w-full">
                            ...
                            {modules.map((mod, index) => (
                                <React.Fragment key={mod.id}>
                                        ...
                                        <section id={`lesson-${lesson.id}`} key={lesson.id} className="scroll-mt-24 pl-4 sm:pl-8">
                                            <div className="bg-card rounded-3xl border border-border p-8 shadow-sm hover:shadow-md transition-shadow">
                                                ...
                                                {(lesson.media_url || lesson.video_url) && (
                                                    <div className="mb-8 rounded-xl overflow-hidden bg-black shadow-lg">
                                                        <video src={lesson.media_url || lesson.video_url} controls className="w-full aspect-video" />
                                                    </div>
                                                )}
                                                ...
                                                {lesson.content_type === 'assessment' && (
                                                    <div className="mb-8">
                                                        <AssessmentViewer lessonId={lesson.id} />
                                                    </div>
                                                )}
                                    ...
                                    {index < modules.length - 1 && <div className="w-full h-px bg-border/50 my-4" />}
                                </React.Fragment>
                            ))}
