...
export default function CourseAssessmentQuestionsPage() {
 ...
 <div>
 <button onClick={() => router.back()} className="flex items-center gap-1 text-xs font-bold text-muted-foreground hover:text-primary transition-colors duration-200 transition-colors uppercase tracking-widest mb-3 cursor-pointer">
