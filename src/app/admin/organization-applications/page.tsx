                    ...
                    {(['pending', 'approved', 'rejected'] as StatusTab[]).map(tab => (
                        ...
                        >
                            ...
                            {tab === 'pending' && totalCount > 0 && activeTab === 'pending' && (
                                <span className="ml-2 bg-yellow-100 text-yellow-700 text-xs px-1.5 py-0.5 rounded-full font-bold">
                                    {totalCount}
                                </span>
                            )}
                        </button>
                                        ...
                                        {app.status === 'pending' && (
                                            <>
                                                <button
                                                    ...
                                                    className="text-green-600 hover:text-green-800 font-semibold mr-3 transition-colors text-sm disabled:opacity-50"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="text-red-500 hover:text-red-700 font-semibold transition-colors text-sm disabled:opacity-50"
                                                >
                                                    Reject
                                                </button>
                                            </>
