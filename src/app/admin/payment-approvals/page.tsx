                                        ...
                                        <div className="flex justify-end gap-1.5">
                                            {isSuperAdmin && (
                                                <>
                                                    {a.status === 'pending' && (
                                                        <>
                                                            <button onClick={() => handleStatusUpdate(a.id, 'approved')} className="px-2.5 py-1 bg-green-600 text-white rounded-lg text-[10px] font-bold hover:bg-green-700 transition-colors uppercase tracking-wider">Approve</button>
                                                            <button onClick={() => handleStatusUpdate(a.id, 'rejected')} className="px-2.5 py-1 bg-red-600 text-white rounded-lg text-[10px] font-bold hover:bg-red-700 transition-colors uppercase tracking-wider">Reject</button>
                                                        </>
                                                    )}
                                                    <button onClick={() => openEditModal(a)} className="px-3 py-1.5 bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 rounded-lg text-xs font-bold transition-colors">Edit</button>
