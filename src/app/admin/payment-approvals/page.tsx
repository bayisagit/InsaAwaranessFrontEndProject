        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            <div className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8 flex justify-between items-center">
                    ...
                    {canCreate && (
                        <Button variant="primary" onClick={openCreateModal}>Create Request</Button>
                    )}
                </div>
            </div>
            ...
            <Modal isOpen={isFormModalOpen} onClose={() => setIsFormModalOpen(false)} title={selectedApproval ? 'Edit Payment Request' : 'Create Payment Request'}>
                <form onSubmit={handleFormSubmit} className="space-y-4">
                    ...
                    <div className="pt-4 flex justify-end gap-3">
                        ...
                        <Button type="submit" variant="primary" disabled={isActionLoading}>{isActionLoading ? 'Saving...' : selectedApproval ? 'Save Changes' : 'Create Request'}</Button>
                    </div>
                </form>
            </Modal>
