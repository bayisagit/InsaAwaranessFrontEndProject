...
export default function AdminReportsPage() {
 ...
 <button onClick={() => setConfirmDelete({ isOpen: true, id: r.id })} className="text-red-500 hover:text-red-700 font-medium transition-colors cursor-pointer">Delete</button>
 </td>
 )}
 </tr>
 ))}
