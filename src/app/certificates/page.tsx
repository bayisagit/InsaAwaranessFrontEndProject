...
export default function CertificatesPage() {
 ...
 <div key={cert.id} className="bg-card rounded-2xl border border-border p-6 shadow-sm shadow-black/5 dark:shadow-none hover:shadow-md shadow-black/10 dark:shadow-none transition-all group cursor-pointer hover:-translate-y-1 transition-all duration-200 ease-in-out">
 ...
 className="flex-1 py-2.5 bg-muted text-foreground font-bold rounded-xl border border-border hover:bg-primary hover:text-white hover:border-primary transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
 >
 ...
 disabled={actionLoading === cert.id}
 className="flex-1 py-2.5 bg-primary/10 text-primary font-bold rounded-xl border border-primary/20 hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
 >
